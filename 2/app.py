...
df = pd.read_csv('C:/Users/sumit/Desktop/speech/datasetcsv/reviews.csv')
...
def predict(text,model,ot):
    ...
    num_files = 1
    folder_path = "C:/Users/sumit/Desktop/speech/2/static/files/images/" 
    folder_path1='C:/Users/sumit/Desktop/speech/2/static/files/audio/'
    folder_path2='C:/Users/sumit/Desktop/speech/2/static/files/video/'
...
def upload():
    ...
    try:
        ...
        if server_transcript and not server_transcript.startswith('['): # Only detect emotion if transcription was successful
            try:
                f=open('D:/code1/speech/speech/task.txt','w')
                ...
                f.close()
            sleep(3)
            f=open('D:/code1/speech/speech/output.txt','r')
            res=f.read()
            f.close()
